...
alter table users
    add constraint fk_users_d_id
       foreign key(d_id ) references department(d_id);
alter table users
    add constraint fk_users_r_id
...
--消息表的u_id外键
alter table message
    add constraint fk_message_m_send
       foreign key(m_send ) references users(u_id);
alter table message
    add constraint fk_message_m_recevie
       foreign key(m_recevie ) references users(u_id);
alter table message
...
alter table document
    add constraint fk_document_do_send
       foreign key(do_send) references users(u_id);       
alter table document
    add constraint fk_document_do_receive
       foreign key(do_receive) references users(u_id); 
alter table document
    add constraint fk_document_fid
       foreign key(fid) references file(fid); 
...
alter table opinion
    add constraint fk_opinion_do_id
       foreign key(do_id ) references document(do_id);
       
alter table opinion
    add constraint fk_opinion_uid
       foreign key(u_id ) references users(u_id);
...
--公告通知表的u_id外键
alter table notice
    add constraint fk_notice_uid
       foreign key(u_id ) references users(u_id);
 
alter table notice
    add constraint fk_notice_fid
       foreign key(fid ) references file(fid);
